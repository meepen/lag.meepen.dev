...
export function BatchBreakdown({
  batch,
  onClose,
}: BatchBreakdownProps): React.ReactElement | null {
  ...
  const packetLossRate =
    totalPackets > 0 ? (lostPackets / totalPackets) * 100 : 0;
            ...
            <Table size="small">
              ...
              <TableBody>
                {batch.results.map((hop, index) => {
                  const hopLossRate =
                    hop.sent > 0 ? (hop.lost / hop.sent) * 100 : 0;
                  ...
                  return (
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        <Typography variant="body2">{hop.sent}</Typography>
                      </TableCell>
                      <TableCell>
                        <Typography variant="body2">{hop.lost}</Typography>
                      </TableCell>
                      <TableCell>
                        <Chip
              ...
              <CardContent>
                <Box sx={{ display: "flex", gap: 3, flexWrap: "wrap" }}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body1">{totalPackets}</Typography>
                  </Box>
                </Box>
              </CardContent>
            </Card>
